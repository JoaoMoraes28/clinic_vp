...
class UF(Base):
    ...
    patient_address: Mapped[list["PatientAddress"]] = relationship(
        back_populates="uf"
    )

    doctor_crm: Mapped[list["Doctor"]] = relationship(
        back_populates="uf"
    )

    doctor_address: Mapped[list["DoctorAddress"]] = relationship(
        back_populates="uf"
    )
